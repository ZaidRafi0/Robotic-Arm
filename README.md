...
Work in progress. See Status for what's done and what's left.
...
Fix the gripper assembly — wrist bracket, housing, pinion, and racks (see What broke).
Wire the arm: five servos to a PCA9685, separate 5-6 V supply, common ground.
Write and tune the inverse kinematics solver.
Specs
Property	Value
